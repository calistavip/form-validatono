...
const banner2 = cfonts.render((`Canal: https://youtube.com/@🜲𝑳𝐈𝐕𝐈𝐀 𝐂𝐀𝐋𝐈𝐒𝐓𝐀 𝐂𝐀𝐑𝐎𝐋𝐈𝐍𝐀🜲\nDesenvolvedor Oficial: @𝑻𝒓𝒐𝒏𝑻𝒆𝒄𝒉𝑨𝑰.exe`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`🜲𝑳𝐈𝐕𝐈𝐀🜲|🜲𝐂𝐀𝐋𝐈𝐒𝐓𝐀🜲`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const authorname = "🜲𝑳𝐈𝐕𝐈𝐀 𝐂𝐀𝐋𝐈𝐒𝐓𝐀 𝐂𝐀𝐑𝐎𝐋𝐈𝐍𝐀🜲"
const packname = "Criador: @𝑻𝒓𝒐𝒏𝑻𝒆𝒄𝒉𝑨𝑰"

const chyt = "5511949981879@s.whatsapp.net";
const nit = "5571992325865@s.whatsapp.net";
const supre = "5511917093720@s.whatsapp.net";
